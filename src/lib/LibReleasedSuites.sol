...
import {LibLogTablesReleased} from "./LibLogTablesReleased.sol";

import {LibDecimalFloatReleased} from "./LibDecimalFloatReleased.sol";
...
library LibReleasedSuites {
    ...
    function releasedSuites() internal pure returns (DeploySuite[] memory) {
        ...
        released[0] = LibLogTablesReleased.releasedSuites();
        released[1] = LibDecimalFloatReleased.releasedSuites();
